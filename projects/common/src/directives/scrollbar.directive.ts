...
import { ScrollbarGeometry, ScrollbarPosition } from '../types/scrollbar.types';
 ...
 */
@Directive({
	selector: '[ontrialScrollbar]',
	exportAs: 'ontrialScrollbar',
	standalone: true,
})
export class ScrollbarDirective implements OnChanges, OnInit, OnDestroy {
	/* eslint-disable @typescript-eslint/naming-convention */
	static ngAcceptInputType_ontrialScrollbar: BooleanInput;
	/* eslint-enable @typescript-eslint/naming-convention */

	@Input() ontrialScrollbar: boolean = true;
	@Input() ontrialScrollbarOptions: PerfectScrollbar.Options | null = null;

	private _animation: number | null = null;
	private _options: PerfectScrollbar.Options | null = null;
	...
	ngOnChanges(changes: SimpleChanges): void {
		// Enabled
		if ('ontrialScrollbar' in changes) {
			// Interpret empty string as 'true'
			this.ontrialScrollbar = coerceBooleanProperty(changes['ontrialScrollbar'].currentValue);

			// If enabled, init the directive
			if (this.ontrialScrollbar) {
				this._init();
			}
		...
		// Scrollbar options
		if ('ontrialScrollbarOptions' in changes) {
			// Merge the options
			this._options = merge({}, this._options, changes['ontrialScrollbarOptions'].currentValue);
