...
export const notifications = [
	{
		...
		time: now.subtract({ minutes: 25 }).toISO(), // 25 minutes ago
		read: false,
	},
	{
		...
		time: now.subtract({ minutes: 50 }).toISO(), // 50 minutes ago
		read: true,
	...
	},
	{
		...
		time: now.subtract({ hours: 3 }).toISO(), // 3 hours ago
		read: false,
		link: '/dashboards/project',
		useRouter: true,
	},
	{
		...
		time: now.subtract({ hours: 5 }).toISO(), // 5 hours ago
		read: false,
		link: '/dashboards/project',
		useRouter: true,
	},
	{
		...
		time: now.subtract({ hours: 7 }).toISO(), // 7 hours ago
		read: true,
		link: '/dashboards/project',
		useRouter: true,
	},
	{
		...
		time: now.subtract({ hours: 9 }).toISO(), // 9 hours ago
		read: true,
		link: '/dashboards/project',
		useRouter: true,
	},
	{
		...
		time: now.subtract({ days: 1 }).toISO(), // 1 day ago
		read: true,
		link: '/dashboards/project',
		useRouter: true,
	},
	{
		...
		time: now.subtract({ days: 3 }).toISO(), // 3 days ago
		read: true,
		link: '/dashboards/project',
		useRouter: true,
	},
	{
		...
		time: now.subtract({ days: 4 }).toISO(), // 4 days ago
		read: true,
		link: '/dashboards/project',
		useRouter: true,
	},
