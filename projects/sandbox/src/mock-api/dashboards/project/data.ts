...
export const project = {
	...
	yearlyExpenses: {
		amount: 648813,
		labels: [
			now.subtract({ days: 79 }).format('dd MMM') + ' - ' + now.subtract({ days: 72 }).format('dd MMM'),
			now.subtract({ days: 71 }).format('dd MMM') + ' - ' + now.subtract({ days: 64 }).format('dd MMM'),
			now.subtract({ days: 63 }).format('dd MMM') + ' - ' + now.subtract({ days: 56 }).format('dd MMM'),
			now.subtract({ days: 55 }).format('dd MMM') + ' - ' + now.subtract({ days: 48 }).format('dd MMM'),
			now.subtract({ days: 47 }).format('dd MMM') + ' - ' + now.subtract({ days: 40 }).format('dd MMM'),
			now.subtract({ days: 39 }).format('dd MMM') + ' - ' + now.subtract({ days: 32 }).format('dd MMM'),
			now.subtract({ days: 31 }).format('dd MMM') + ' - ' + now.subtract({ days: 24 }).format('dd MMM'),
			now.subtract({ days: 23 }).format('dd MMM') + ' - ' + now.subtract({ days: 16 }).format('dd MMM'),
