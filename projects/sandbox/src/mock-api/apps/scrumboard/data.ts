...
export const boards = [
	{
		...
		lastActivity: now.startOf('day').subtract({ days: 1 }).toISO(),
		members: [
	...
	},
	{
		...
		lastActivity: now.startOf('day').subtract({ days: 2 }).toISO(),
		members: [
	...
	},
	{
		...
		lastActivity: now.startOf('day').subtract({ weeks: 1 }).toISO(),
		members: [
...
export const cards = [
	{
		...
		dueDate: now.startOf('day').subtract({ days: 10 }).toISO(),
	},
	{
	...
	},
	{
		...
		dueDate: now.startOf('day').subtract({ days: 1 }).toISO(),
	},
	{
