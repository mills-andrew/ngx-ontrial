...
export const notes = [
	...
	},
	{
		...
		createdAt: now.set({
			hours: 19,
			minutes: 27,
		}).subtract({ days: 74 }).toISO(),
		updatedAt: now.set({
			hours: 15,
			minutes: 36,
		}).subtract({ days: 50 }).toISO(),
	},
	{
	...
	},
	{
		...
		reminder: now.set({
			hours: 14,
			minutes: 56,
		}).subtract({ days: 25 }).toISO(),
		labels: ['f47c92e5-20b9-44d9-917f-9ff4ad25dfd0'],
		archived: false,
		createdAt: now.set({
			hours: 14,
			minutes: 56,
		}).subtract({ days: 20 }).toISO(),
		updatedAt: null,
	},
	{
		...
		createdAt: now.set({
			hours: 9,
			minutes: 32,
		}).subtract({ days: 15 }).toISO(),
		updatedAt: now.set({
			hours: 17,
			minutes: 6,
		}).subtract({ days: 12 }).toISO(),
	},
	{
