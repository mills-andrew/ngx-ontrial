...
@Component({
	...
	imports: [FormsModule, ReactiveFormsModule, MatDialogModule, MatButtonModule, NgIf, MatIconModule, MatMenuModule, RouterLink, MatDividerModule, MatFormFieldModule, MatInputModule, TextFieldModule, NgFor, MatRippleModule, MatCheckboxModule, NgClass, MatDatepickerModule, FindByKeyPipe, DatePipe],
})
export class TasksDetailsComponent implements OnInit, AfterViewInit, OnDestroy {
	...
	ngOnInit(): void {
		...
		this._tasksService.task$
			...
			.subscribe((task: Task | null) => {
				...
				if (task === null) {
					throw new Error("An unexpected error occured: 182");
				}
	...
	toggleCompleted(): void {
		...
		if (completedFormControl === null) {
			throw new Error("An unexpected error occured: 129");
		}
	...
	filterTags(event: any): void {
		...
		if (this.tags === null) {
			throw new Error("An unexpected error occured: 130.");
		}
	...
	filterTagsInputKeyDown(event: any): void {
		if (this.filteredTags === null || this.task === null) {
			throw new Error("An unexpected error occured: 131.");
		}
	 ...
	 * @param event
	 */
	updateTagTitle(tag: Tag, event: any): void {
	...
	addTagToTask(tag: Tag): void {
		...
		if (this.task === null) {
			throw new Error("An unexpected error occured: 133.");
		}
