...
import { INavigationEntity, NavigationEntityService, VerticalNavigationComponent } from '@ngx-ontrial/layout';
		...
		this._tasksService.tasks$
			...
			.subscribe((tasks: Task[] | null) => {
				...
				setTimeout(() => {
					...
					const mainNavigationComponent = this._navigationService.getComponent<VerticalNavigationComponent>('mainNavigation');

					// If the main navigation component exists...
					if (mainNavigationComponent) {
						const mainNavigation = mainNavigationComponent.navigation;
						const menuItem: INavigationEntity | null = this._navigationService.getItem('apps.tasks', mainNavigation);

						if (menuItem === null) {
							throw new Error("Could not find the menu Item");
						}
