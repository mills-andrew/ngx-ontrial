...
import { AlertComponent } from '@ngx-ontrial/material';
...
@Component({
	...
	standalone: true,
	imports: [MatButtonModule, RouterLink, MatIconModule, NgIf, AlertComponent, FormsModule, ReactiveFormsModule, MatFormFieldModule, MatInputModule, TextFieldModule],
})
