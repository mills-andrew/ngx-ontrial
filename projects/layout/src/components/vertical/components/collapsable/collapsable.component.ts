...
export class VerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy {
	...
	@HostBinding('class') get classList(): any {
		/* eslint-disable @typescript-eslint/naming-convention */
		return {
			'ontrial-vertical-navigation-item-collapsed': this.isCollapsed,
			'ontrial-vertical-navigation-item-expanded': this.isExpanded,
		};
		/* eslint-enable @typescript-eslint/naming-convention */
	}
	...
	ngOnInit(): void {
		...
		this._ontrialVerticalNavigationComponent!.onCollapsableItemCollapsed
		...
		if (this.autoCollapse) {
			this._ontrialVerticalNavigationComponent!.onCollapsableItemExpanded
				.pipe(takeUntil(this._unsubscribeAll))
	...
	collapse(): void {
		...
		this._ontrialVerticalNavigationComponent!.onCollapsableItemCollapsed.next(this.item!);
	}
	...
	expand(): void {
		...
		// Execute the observable
		this._ontrialVerticalNavigationComponent!.onCollapsableItemExpanded.next(this.item!);
	}
