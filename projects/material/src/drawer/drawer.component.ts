...
@Component({
	selector: 'ontrial-drawer',
	templateUrl: './drawer.component.html',
	styleUrls: ['./drawer.component.scss'],
	encapsulation: ViewEncapsulation.None,
	exportAs: 'ontrialDrawer',
	standalone: true,
})
export class DrawerComponent implements OnChanges, OnInit, OnDestroy {
	...
	constructor(
		...
		private _ontrialDrawerService: DrawerService,
	...
	@HostBinding('class') get classList(): any {
		/* eslint-disable @typescript-eslint/naming-convention */
		return {
			'ontrial-drawer-animations-enabled': this._animationsEnabled,
			'ontrial-drawer-fixed': this.fixed,
			'ontrial-drawer-hover': this._hovered,
			[`ontrial-drawer-mode-${this.mode}`]: true,
			'ontrial-drawer-opened': this.opened,
			[`ontrial-drawer-position-${this.position}`]: true,
		};
		/* eslint-enable @typescript-eslint/naming-convention */
	}
	...
	ngOnInit(): void {
		// Register the drawer
		this._ontrialDrawerService.registerComponent(this.name, this);
	}
	...
	ngOnDestroy(): void {
		...
		this._ontrialDrawerService.deregisterComponent(this.name);
	}
	...
	private _showOverlay(): void {
		...
		this._overlay?.classList.add('ontrial-drawer-overlay');

		// Add a class depending on the fixed option
		if (this.fixed) {
			this._overlay?.classList.add('ontrial-drawer-overlay-fixed');
		}

		// Add a class depending on the transparentOverlay option
		if (this.transparentOverlay) {
			this._overlay?.classList.add('ontrial-drawer-overlay-transparent');
		}
