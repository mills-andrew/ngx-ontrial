...
@Component({
	selector: 'textarea[ontrial-highlight]',
	templateUrl: './highlight.component.html',
	styleUrls: ['./highlight.component.scss'],
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	exportAs: 'ontrialHighlight',
	standalone: true,
	imports: [NgClass],
})
export class HighlightComponent implements OnChanges, AfterViewInit {
	...
	constructor(
		...
		private _ontrialHighlightService: HighlightService,
	...
	private _highlightAndInsert(): void {
		...
		this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._ontrialHighlightService.highlight(this.code, this.lang));
